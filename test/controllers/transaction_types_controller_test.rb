...
class TransactionTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transaction_type" do
    assert_difference('TransactionType.count') do
      post transaction_types_url, params: { transaction_type: { description: @transaction_type.description, nature: @transaction_type.nature, signal: @transaction_type.signal } }, as: :json
    end
  ...
  test "should update transaction_type" do
    patch transaction_type_url(@transaction_type), params: { transaction_type: { description: @transaction_type.description, nature: @transaction_type.nature, signal: @transaction_type.signal } }, as: :json
    assert_response 200
  end
